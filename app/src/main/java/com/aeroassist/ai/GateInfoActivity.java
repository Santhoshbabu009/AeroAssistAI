...
public class GateInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.guideBody)).setText(
            "â€¢ Gate A1 - A10: Near Security Checkpoint Alpha.\n" +
            "â€¢ Gate A11 - A20: East Wing (8 mins walk).\n" +
            "â€¢ Gate B1 - B25: International Pier North.\n" +
            "â€¢ Gate B26 - B50: International Pier South.\n\n" +
